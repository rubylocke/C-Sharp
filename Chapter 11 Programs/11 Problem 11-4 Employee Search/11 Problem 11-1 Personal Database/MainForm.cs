...
namespace _11_Problem_11_1_Personal_Database
{
    public partial class MainForm : Form
    {
        ...
        {
            // Calling the SearchName method that takes the value
            // entered in tbSearchValue textbook as an argument
            this.employeeTableAdapter.FillBySearchName(this.employeeDataSet.Employee, tbSearchValue.Text);
        }
