...
namespace _11_Problem_11_1_Personal_Database {
    ...
    public partial class EmployeeDataSet : global::System.Data.DataSet {
        ...
        public partial class EmployeeDataTable : global::System.Data.TypedTableBase<EmployeeRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public EmployeeRow AddEmployeeRow(string empID, string name, string position, decimal hourlyPayRate) {
...
namespace _11_Problem_11_1_Personal_Database.EmployeeDataSetTableAdapters {
    ...
    public partial class EmployeeTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Employee] WHERE (([empID] = @Original_empID) AND ([name] = @Or" +
                "iginal_name) AND ([position] = @Original_position) AND ([hourlyPayRate] = @Origi" +
                "nal_hourlyPayRate))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Employee] ([empID], [name], [position], [hourlyPayRate]) VALUE" +
                "S (@empID, @name, @position, @hourlyPayRate);\r\nSELECT empID, name, position, hou" +
                "rlyPayRate FROM Employee WHERE (empID = @empID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Employee] SET [empID] = @empID, [name] = @name, [position] = @position, [hourlyPayRate] = @hourlyPayRate WHERE (([empID] = @Original_empID) AND ([name] = @Original_name) AND ([position] = @Original_position) AND ([hourlyPayRate] = @Original_hourlyPayRate));
SELECT empID, name, position, hourlyPayRate FROM Employee WHERE (empID = @empID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::_11_Problem_11_1_Personal_Database.Properties.Settings.Default.PersonnelConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT empID, name, position, hourlyPayRate FROM dbo.Employee";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT empID, name, position, hourlyPayRate \r\nFROM dbo.Employee\r\nORDER BY hourlyP" +
                "ayRate ASC";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[2] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[2].Connection = this.Connection;
            this._commandCollection[2].CommandText = "SELECT empID, name, position, hourlyPayRate \r\nFROM dbo.Employee\r\nORDER BY hourlyP" +
                "ayRate DESC";
        ...
        public virtual int FillByHourPayRateAsc(EmployeeDataSet.EmployeeDataTable dataTable) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, false)]
        public virtual int FillByHourPayRateDesc(EmployeeDataSet.EmployeeDataTable dataTable) {
        ...
        public virtual int Delete(string Original_empID, string Original_name, string Original_position, decimal Original_hourlyPayRate) {
        ...
        public virtual int Insert(string empID, string name, string position, decimal hourlyPayRate) {
            if ((empID == null)) {
        ...
        public virtual int Update(string empID, string name, string position, decimal hourlyPayRate, string Original_empID, string Original_name, string Original_position, decimal Original_hourlyPayRate) {
            if ((empID == null)) {
                throw new global::System.ArgumentNullException("empID");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string name, string position, decimal hourlyPayRate, string Original_empID, string Original_name, string Original_position, decimal Original_hourlyPayRate) {
            return this.Update(Original_empID, name, position, hourlyPayRate, Original_empID, Original_name, Original_position, Original_hourlyPayRate);
        }
    }
